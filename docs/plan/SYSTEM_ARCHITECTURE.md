...
> - [PLAN_APP.md](PLAN_APP.md) — Flutter mobile app + BLE pairing flow *(repo này)*
> - [PLAN_ROBOT.md](https://github.com/trungnguyen278/Luni_Robot/blob/main/docs/plan/PLAN_ROBOT.md) — Robot firmware refactoring *(Luni_Robot)*
